...
import { ImplementationSelectionData } from "./SelectActionImpl.container";
import { ErrorAlert, CenteredSpinner } from "../../layout";
...
export interface ClusterProvisioningProps {
  isLoading: boolean;
  error?: Error;
  ...
  implementation: ImplementationSelectionData[];
  currentImplPath: string | undefined;
}

export interface ImplementationExtended extends ImplementationSelectionData {
  disabled: boolean;
}

export function SelectActionImpl({
  isLoading,
  error,
  implementation,
  setActionImplPath,
