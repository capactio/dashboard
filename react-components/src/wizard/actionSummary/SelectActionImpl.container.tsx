...
export function SelectActionImplContainer({
  ...
  const impls = rawData.map((item) => {
    ...
    return {
      ...
      typeRef: inputs,
    } as ImplementationSelectionData;
  });
